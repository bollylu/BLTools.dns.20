...
namespace BLTools.Text {
  ...
  public static class TextBoxExtensions {
    ...
    public static string BoxIBM(this string source, int margin = 0, TextBox.EStringAlignment alignment = TextBox.EStringAlignment.Center, char filler = '.') {
    ...
    /// <returns>A string containing the message in the box</returns>
    public static string Box(this string source, int margin = 0, TextBox.EStringAlignment alignment = TextBox.EStringAlignment.Center, char filler = '.', string border = "") {
    ...
    /// <param name="border">The border string (top-left/top/top-right/right/bottom-right/bottom/bottom-left/left)</param>
    /// <returns>A string containing the message in the box</returns>
    public static string Box(this string source, string title, int margin = 0, TextBox.EStringAlignment alignment = TextBox.EStringAlignment.Center, char filler = '.', string border = "") {
