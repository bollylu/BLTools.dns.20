...
namespace BLTools {
  public enum EActionManagerExecutionType {
    First,
    Last,
    All
  }
  ...
  public class TActionManager {
    protected readonly List<TActionManagerItem> _Actions = new List<TActionManagerItem>();
    ...
    public void AddFunc<X, R>(string name, Predicate<X> predicate, Func<X, R> func) {
      lock (_LockActions) {
    ...
    /// <param name="predicate">The predicate that determine if the function is processed</param>
    /// <param name="func">The function to process when the predicate is true</param>
    public void AddFunc<X1, X2, R>(string name, Predicate<X1> predicate, Func<X1, X2, R> func) {
      lock (_LockActions) {
    ...
    /// <param name="predicate">The predicate that determine if the function is processed</param>
    /// <param name="func">The function to process when the predicate is true</param>
    public void AddFunc<X1, X2, X3, R>(string name, Predicate<X1> predicate, Func<X1, X2, X3, R> func) {
      lock (_LockActions) {
    ...
    /// <param name="predicate">The predicate that determine if the function is processed</param>
    /// <param name="func">The function to process when the predicate is true</param>
    public void AddFunc<X1, X2, X3, X4, R>(string name, Predicate<X1> predicate, Func<X1, X2, X3, X4, R> func) {
      lock (_LockActions) {
    ...
    public R ExecuteFunc<X1, R>(X1 value, EActionManagerExecutionType executionType = EActionManagerExecutionType.First) {
      if (_Actions.IsEmpty()) {
        return default(R);
      }
    ...
    public R ExecuteFunc<X1, X2, R>(X1 arg1, X2 arg2, EActionManagerExecutionType executionType = EActionManagerExecutionType.First) {
      if (_Actions.IsEmpty()) {
        return default(R);
      }
    ...
    public R ExecuteFunc<X1, X2, X3, R>(X1 arg1, X2 arg2, X3 arg3, EActionManagerExecutionType executionType = EActionManagerExecutionType.First) {
      if (_Actions.IsEmpty()) {
        return default(R);
      }
    ...
    public R ExecuteFunc<X1, X2, X3, X4, R>(X1 arg1, X2 arg2, X3 arg3, X4 arg4, EActionManagerExecutionType executionType = EActionManagerExecutionType.First) {
      if (_Actions.IsEmpty()) {
        return default(R);
      }
